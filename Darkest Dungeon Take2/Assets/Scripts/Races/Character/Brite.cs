...
[System.Serializable]
public class Brite : MonoBehaviour {
	...
	void Start() {
		className = "Brite";
		health = 10 + dice.RollDice(3) + skills.BritHealth + skills.HealthBuff;
		damage = 2 + skills.BritDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.BritHealth + skills.HealthBuff;
