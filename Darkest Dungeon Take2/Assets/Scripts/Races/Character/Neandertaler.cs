...
[System.Serializable]
public class Neandertaler : MonoBehaviour {
	...
	void Start() {
		className = "Neandertaler";
		health = 10 + dice.RollDice(3) + skills.NHealth + skills.HealthBuff;
		damage = 2 + skills.NDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.NHealth + skills.HealthBuff;
