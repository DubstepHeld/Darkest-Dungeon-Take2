...
[System.Serializable]
public class HomoSapiens : MonoBehaviour {
	...
	void Start() {
		className = "HomoSapiens";
		health = 10 + dice.RollDice(3) + skills.HSHealth + skills.HealthBuff;
		damage = 2 + skills.HSDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.HSHealth + skills.HealthBuff;
