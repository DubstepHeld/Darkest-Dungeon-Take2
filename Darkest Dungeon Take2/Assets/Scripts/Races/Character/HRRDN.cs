...
[System.Serializable]
public class HRRDN : MonoBehaviour {
	...
	void Start() {
		className = "HRRDN";
		health = 10 + dice.RollDice(3) + skills.HRRDNHealth + skills.HealthBuff;
		damage = 2 + skills.HRRDNDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.HRRDNDamage + skills.HealthBuff;
