...
public class Isis : MonoBehaviour {
	...
	void Start() {
		className = "Isis";
		health = 10 + dice.RollDice(3) + skills.IsisHealth + skills.HealthBuff;
		damage = 2 + skills.IsisDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice (3) + skills.IsisHealth + skills.HealthBuff;
