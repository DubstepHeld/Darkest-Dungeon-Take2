...
[System.Serializable]
public class Roemer : MonoBehaviour {
	...
	void Start() {
		className = "Roemer";
		health = 10 + dice.RollDice(3) + skills.RoemerHealth + skills.HealthBuff;
		damage = 2 + skills.RoemerDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.RoemerHealth + skills.HealthBuff;
