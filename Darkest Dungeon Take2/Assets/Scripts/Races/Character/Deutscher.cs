...
[System.Serializable]
public class Deutscher : MonoBehaviour {
	...
	void Start() {
		className = "Deutscher";
		health = 10 + dice.RollDice(3) + skills.DHealth + skills.HealthBuff;
		damage = 2 + skills.DDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.DHealth + skills.HealthBuff;
