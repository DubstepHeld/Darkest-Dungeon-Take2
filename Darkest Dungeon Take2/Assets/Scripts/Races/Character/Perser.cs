...
public class Perser : MonoBehaviour {
	...
	void Start() {
		className = "Perser";
		health = 10 + dice.RollDice(3) + skills.PerserHealth + skills.HealthBuff;
		damage = 2 + skills.PerserDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.PerserHealth + skills.HealthBuff;
