...
[System.Serializable]
public class Franzmann : MonoBehaviour {
	...
	void Start() {
		className = "Franzsose";
		health = 10 + dice.RollDice(3) + skills.FrHealth + skills.HealthBuff;
		damage = 2 + skills.FrDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.FrHealth + skills.HealthBuff;
