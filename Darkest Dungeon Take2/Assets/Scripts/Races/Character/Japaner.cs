...
public class Japaner : MonoBehaviour {
	...
	void Start() {
		className = "Japaner";
		health = 10 + dice.RollDice(3) + skills.AssHealth + skills.HealthBuff;
		damage = 2 + skills.AssDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.AssHealth + skills.HealthBuff;
