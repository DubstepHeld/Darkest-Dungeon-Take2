...
[System.Serializable]
public class Amerikaner : MonoBehaviour {
	...
	void Start() {
		className = "Amerikaner";
		health = 10 + dice.RollDice(3) + skills.AmiHealth + skills.HealthBuff;
		damage = 2 + skills.AmiDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.AmiHealth + skills.HealthBuff;
