...
[System.Serializable]
public class Aegypter : MonoBehaviour {
	...
	void Start() {
		className = "Aegypter";
		health = 10 + dice.RollDice(3) + skills.AegypterHealth + skills.HealthBuff;
		damage = 2 + skills.AegypterDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3) + skills.AegypterHealth + skills.HealthBuff;
