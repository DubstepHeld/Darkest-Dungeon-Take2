...
public class Barbar : MonoBehaviour {
	...
	void Start() {
		className = "Barbar";
		health = 10 + dice.RollDice(3) + skills.BarbarHealth + skills.HealthBuff;
		damage = 2 + skills.BarbarDamage + skills.DamageBuff;
	...
	public void Reroll() {
		health = 12 + dice.RollDice(3)  + skills.BarbarHealth + skills.HealthBuff;
