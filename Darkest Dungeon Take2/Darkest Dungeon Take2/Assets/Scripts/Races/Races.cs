...
public class Races : MonoBehaviour {
	...
	public Aegypter aegypter;
	public Amerikaner amerikaner;
	public Barbar barbar;
	public Brite brite;
	public Deutscher deutscher;
	public Franzmann franzmann;
	public HRRDN hrrdn;
	public Isis isis;
	public Japaner japaner;
	public Neandertaler neandertaler;
	public Perser perser;
	public Roemer roemer;
	public HomoSapiens homosapiens;
